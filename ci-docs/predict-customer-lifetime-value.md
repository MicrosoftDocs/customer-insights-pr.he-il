...
1. בשלב **נתונים נוספים (אופציונלי)**, בחר **הוסף נתונים** תחת **‏‫שפר את התובנות של המודלים באמצעות נתוני פעילות נוספים‬**. בחר את ישות פעילות הלקוח המספקת את פרטי פעילות הלקוח כמתואר ב[דרישות המוקדמות](#prerequisites).
...
1. הוסף נתוני לקוחות אופציונליים או בחר **הבא**.
...
1. בשלב **נתונים נוספים (אופציונלי)**, בחר **הוסף נתונים** תחת **‏‫שפר את התובנות של המודלים באמצעות נתוני לקוח נוספים‬**.

1. עבור **ישות**, בחר **לקוח : CustomerInsights** כדי לבחור את טבלת פרופיל הלקוח המאוחד שממפה לנתוני תכונת לקוח. עבור **מזהה לקוח**, בחר **System.Customer.CustomerId**.
...
1. בחר **שמור** לאחר מיפוי התכונות שבהן המודל צריך להשתמש כדי לעזור לחזות את ערך אורך חיי הלקוח.
