...
ms.locfileid: "8755499"
---
# <a name="customer-activities"></a>פעילויות של לקוחות

שלב פעילויות של לקוחות מ[מקורות נתונים שונים](data-sources.md) ב- Dynamics 365 Customer Insights. צור ציר זמן המפרט את הפעילויות באופן כרונולוגי. כלול את ציר הזמן באפליקציות Dynamics 365 עם פתרון של [תוסף כרטיס לקוח](customer-card-add-in.md).
...
אם לקוח השתתף בפעילות מוגדרת, תמצא אותו במקטע **ציר זמן של פעילות**.
