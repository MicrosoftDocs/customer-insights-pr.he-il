...
ms.locfileid: "9170636"
---
# <a name="create-complex-segments-with-segment-builder"></a>יצירת פלחים מורכבים בעזרת בונה הפלחים

הגדר מסננים מורכבים סביב ישות הלקוחות המאוחדים והישויות הקשורות אליה. כל פלח, לאחר העיבוד, יוצר קבוצה של רשומות לקוחות שתוכל לייצא ולבצע עליה פעולה.
...
1. אם כלל משתמש בישויות אחרות מלבד הישות *לקוח*, בחר **קבע נתיב קשר** למיפוי הישות שנבחרה לישות הלקוח המאוחדת. אם יש רק נתיב קשר אחד אפשרי, המערכת תבחר אותו באופן אוטומטי. [נתיבי קשר](relationships.md#relationship-paths) שונים יכולים להניב תוצאות שונות. לכל כלל יכול להיות נתיב קשר משלו.
...
1. כברירת מחדל, ישות הפלט תכיל אוטומטית את כל התכונות של פרופילי לקוח שמתאימות למסננים שהוגדרו. אם פלח מבוסס על ישויות אחרות מלבד הישות *לקוח*, בחר **תכונות פרויקט** כדי להוסיף תכונות נוספות מישויות אלה לישות הפלט.
