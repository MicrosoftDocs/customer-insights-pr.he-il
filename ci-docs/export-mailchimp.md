...
- [חשבון MailChimp](https://mailchimp.com/) ואישורי מנהל מערכת מתאימים.
- [קהלים קיימים ב- MailChimp](https://mailchimp.com/help/create-audience/) ו[מזהי קהלים](https://mailchimp.com/help/find-audience-id/) תואמים.
...
1. בחר **הוסף חיבור** ובחר **MailChimp**.
...
1. בשדה **חיבור לייצוא**, בחר חיבור מתוך מקטע Mailchimp. צור קשר עם מנהל מערכת אם אין חיבור זמין.

1. הזן שם עבור הייצוא.

1. הזן את **מזהה קהל MailChimp** שלך.

1. במקטע **התאמת נתונים**, בשדה **דואר אלקטרוני**, בחר בשדה שמייצג כתובת דואר אלקטרוני של לקוח.

1. לחלופין, יצא **שם פרטי** ו **שם משפחה** כדי ליצור הודעות דואר אלקטרוני מותאמות אישית יותר. בחר **הוסף תכונה** כדי למפות שדות אלה.
