...
## <a name="get-insights-on-existing-segments"></a>השג תובנות לגבי פלחים קיימים

גלה מידע נוסף סביב הפלחים הקיימים שלך באמצעות [תובנות על פלח שוק](segment-insights.md). גלה מה מבדיל בין שני פלחים או מה משותף להם.

## <a name="find-similar-customers"></a>מצא לקוחות דומים

אתר לקוחות הדומים לחברי הפלח שנבחר בעזרת בינה מלאכותית. לקבלת מידע נוסף, ראה [לקוחות דומים ](find-similar-customer-segments.md).
