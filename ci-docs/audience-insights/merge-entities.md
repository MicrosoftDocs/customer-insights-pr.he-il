...
התייחס לקבוצת שדות כאל יחידה אחת. לדוגמה, כאשר הרשומות שלנו מכילות את השדות כתובת1, כתובת2, עיר, מדינה/אזור ומיקוד. סביר להניח שלא נרצה למזג בכתובת 2 של רשומה אחרת, מתוך מחשבה שזה יהפוך את הנתונים שלנו למלאים יותר

1. בדף **מזג**, בחר **שלב**.

1. בחר באפשרות **קבוצת שדות**.

1. ציין את מדיניות הזוכה במיזוג ברשימה הנפתחת **דרג שדות לפי**.

1. בחר **הוסף** ובחר אם ברצונך להוסיף עוד שדות או קבוצות נוספות לשדות.
