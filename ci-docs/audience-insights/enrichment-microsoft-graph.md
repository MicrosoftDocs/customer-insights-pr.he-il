...
[קבל מידע נוסף אודות Microsoft Graph](/graph/overview).
...
- בעת [העשרת פרופילים](#refresh-enrichment), אנחנו נעשיר את כל פרופילי הלקוחות שעבורם אנחנו מקבלים נתונים עבור המותגים ותחומי העניין שנבחרו. כולל פרופילים שאינם במדינה או באזור שנבחרו. לדוגמה, אם בחרת בגרמניה, אנו נעשיר פרופילים שנמצאים בארצות הברית אם יש לנו נתוני Microsoft Graph זמינים עבור המותגים והאינטרסים שנבחרו בארה"ב.
...
בחר **ישות מועשרת** ובחר את ערכת הנתונים שברצונך להעשיר בנתוני החברה מתוך Microsoft Graph. באפשרותך לבחור את הישות 'לקוח' כדי להעשיר את כל פרופילי הלקוחות שלך או לבחור ישות פלח כדי להעשיר רק פרופילי לקוחות הנכללים בפלח זה.
