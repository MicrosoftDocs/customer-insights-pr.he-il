...
1. בחר את התכונה שברצונך להשתמש בה כרמה משנית, ולאחר מכן בחר **הוסף**
...
### <a name="provide-an-optional-list-of-benchmark-accounts-business-accounts-only"></a>ספק רשימה אופציונלית של חשבונות המהווים אמת מידה (חשבונות עסקיים בלבד)
