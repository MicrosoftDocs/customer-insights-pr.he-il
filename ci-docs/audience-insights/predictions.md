...
1. לארגון שלך יש מופע [הגדרה ב- Common Data Service](https://docs.microsoft.com/ai-builder/build-model#prerequisites) והוא באותו ארגון כשל Customer Insights.

2. הסביבה שלך קשורה למופע Common Data Service שלך.

אם אתה [יוצר סביבה חדשה](manage-environments.md), הגדר אותה בתיבת הדו-שיח **צור סביבה** ובחר **מתקדם**. אם כבר יצרת סביבה, עבור להגדרות שלה ובחר **מתקדם**. כך או כך, במקטע **השתמש בחיזויים**, הזן את כתובת ה- URL של מופע Common Data Service שאליו ברצונך לצרף את הסביבה שלך.
...
5. עדכן את הדגם שלך ב- AI Builder. [למידע נוסף על ניהול דגמים ב-AI Builder](https://docs.microsoft.com/ai-builder/manage-model#retrain-and-republish-existing-models).
...
אם אינך יכול להשלים את תהליך צירוף Common Data Service עקב שגיאה, תוכל לנסות להשלים את התהליך ידנית. קיימות שתי בעיות מוכרות שיכולול להופיע בתהליך הצירוף:
