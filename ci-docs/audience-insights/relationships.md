...
ארגונים יוצרים הירארכיות חשבונות כדי לנהל טוב יותר חשבונות ואת הקשרים שלהם אלה עם אלה. יכולת תובנות הקהל תומכת בהירארכיות חשבונות של אב-צאצא שכבר קיימות בנתוני הלקוח שעובדו. לדוגמה, חשבונות מ- Dynamics 365 Sales. ניתן להגדיר הירארכיות אלה בדף **קשרים** בתובנות קהל, תחת הכרטיסיה 'הירארכיית חשבון'.
