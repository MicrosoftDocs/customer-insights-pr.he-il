...
1. הגדר **תקופת זמן חיזוי** כדי להגדיר עד איזו נקודת זמן בעתיד ברצונך לחזות את ה- CLV.    
   ...
   > [!TIP]
   > כדי לחזות במדויק CLV עבור פרק הזמן שהגדרת, אתה זקוק לתקופה ניתנת להשוואה של נתונים היסטוריים. לדוגמה, אם ברצונך לחזות את 12 החודשים הבאים, מומלץ שיהיו לך לפחות 18-24 חודשים של נתונים היסטוריים.
...
1. בשלב **לוח זמנים לעדכון נתונים**, בחר את תדירות התרגול מחדש של המודל שלך בהסתמך על הנתונים העדכניים ביותר. הגדרה זו חשובה כדי לעדכן את דיוק החיזויים כאשר נתונים חדשים מעובדים ב- Audience Insights. מרבית העסקים יכולים לבצע אימון פעם בחודש ולקבל דיוק טוב לחיזוי שלהם.
...
- **ביצועי מודל להכשרה**:‏ A,‏ B או C הם דירוגים אפשריים. דירוג זה מציין את הביצועים של החיזוי ויכול לעזור לך לקבל את ההחלטה להשתמש בתוצאות המאוחסנות בישות הפלט. בחר **קבל מידע על ניקוד זה** כדי להבין טוב יותר את מדדי ביצועי המודל הבסיסיים וכיצד נגזר הדירוג הסופי של ביצועי המודל.
  ...
  *CLV לכל לקוח = רכישה חודשית ממוצעת שביצע הלקוח בחלון הלקוח הפעיל * מספר החודשים בתקופת החיזוי של CLV * שיעור השמירה הכולל של כל הלקוחות*
...
החיזויים עוברים רענון באופן אוטומטי באותו [לוח זמנים שבו הנתונים שלך עוברים רענון](system.md#schedule-tab) כפי שמוגדר בהגדרות. באפשרותך לרענן אותם גם באופן ידני.

1. עבור אל **בינה** > **חיזויים** ובחר את הכרטיסיה **החיזויים שלי**.
2. בחר בשלוש הנקודות האנכיות לצד החיזוי שברצונך לרענן.
3. בחר **רענן**.
...
1. עבור אל **בינה** > **חיזויים** ובחר את הכרטיסיה **החיזויים שלי**.
2. בחר בשלוש הנקודות האנכיות לצד החיזוי שברצונך למחוק.
3. בחר **מחק**.

## <a name="troubleshoot-a-failed-prediction"></a>פתור בעיה של חיזוי שנכשל

1. עבור אל **בינה** > **חיזויים** ובחר את הכרטיסיה **החיזויים שלי**.
2. בחר את שלוש הנקודות האנכיות לצד התחזית שברצונך להציג יומני שגיאה עבורה.
3. בחר **יומנים**.
4. סקירת כל השגיאות. יש מספר סוגים של שגיאות שיכולות להתרחש, והם מתארים איזה מצב גרם לשגיאה. לדוגמה, שגיאה שאין מספיק נתונים לחיזוי מדויק נפתרת בדרך כלל על-ידי טעינת נתונים נוספים לתוך תובנות הקהל.
