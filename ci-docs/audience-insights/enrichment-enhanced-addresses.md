...
המודל שלנו מבצע תהליך דו-שלבי לשיפור כתובת. תחילה, הוא מנתח את הכתובת לזיהוי הרכיבים שלה ומציב אותם בתבנית מובנית. לאחר מכן, אנו משתמשים בבינה מלאכותית כדי לתקן, להשלים ולתקנן את הערכים בכתובת.

### <a name="example"></a>דוגמה

פרטי כתובת עשויים להופיע בתבנית לא מתוקננת ולכלול שגיאות כתיב. המודל יכול לפתור את הבעיות הללו וליצור כתובות עקביות בפרופילי לקוחות מאוחדים.
...
המודל משתמש בטכניקות מבוססות למידת מכונה כדי לשפר כתובות. על אף שאנו מחילים סף מהימנות גבוה למצב שבו המודל משנה ערך קלט, בדומה למודל מבוסס למידת מכונה (ML), לא מובטח דיוק של 100%.
...
1. בחר את התבנית של הכתובות בערכת הנתונים שלך. בחר **כתובת בעלת תכונה יחידה** אם הכתובות בנתונים שלך משתמשות בשדה יחיד. בחר **כתובת בעלת תכונות מרובות** אם הכתובות בנתונים שלך משתמשות ביותר משדה נתונים אחד.
   ...
   > [!NOTE]
   > מדינה/אזור הוא שדה חובה הן בכתובות בעלות תכונה יחידה והן בכתובות בעלות תכונות מרובות. לא תתבצע העשרה של כתובות שאינן מכילות ערכים חוקיים או נתמכים של מדינה/אזור
