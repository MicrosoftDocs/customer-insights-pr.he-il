...
> - ניתן להגדיר כרגע רק ישות אחת של היסטוריית עסקאות. אם קיימות ישויות רכישה מרובות, אחד אותן ב- Power Query לפני עיבוד הנתונים.
...
1. אם בחרת *לא* להמליץ על מוצרים שנרכשו לאחרונה, הגדר את **חלון מבט לאחור**. הגדרה זו מציינת את מסגרת זמן שהמודל לוקח בחשבון לפני שהוא ממליץ שוב על המוצר למשתמש. לדוגמה, ציין שלקוח רוכש מחשב נייד אחת לשנתיים. חלון זה יסתכל על היסטוריית הרכישות בשנתיים האחרונות, ואם ימצא פריט, הפריט יסונן מההמלצות.
